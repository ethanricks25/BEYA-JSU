...
class HospPage(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        label = Label(self.canvas, text="Input Patient Dataset", font=self.mainFont, bg='white', fg='#191D23')
